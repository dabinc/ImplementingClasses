...
# ----------------------------------------------------------------------
# TOD O: 2. With your instructor, READ THE INSTRUCTIONS
...
class Point(object):
    ...
    def move_to(self,x,y):
        self.traveled += self.get_distance_from(Point(x, y))
        self.x=x
        self.y=y
    ...
    def move_by(self,dx,dy):
        self.traveled += self.get_distance_from(Point(self.x + dx, self.y + dy))
        self.x= self.x+dx
        self.y = self.y +dy
        self.moves=self.moves+1
...
def test_repr():
    ...
    """
    # ------------------------------------------------------------------
    # TO DO: 4.  Follow the same instructions as in TO DO 3 above,
...
def test_clone():
   ...
   """
    # ------------------------------------------------------------------
    # TO DO: 5.  Follow the same instructions as in TOD O 3 above,
...
def test_move_to():
    ...
    """
    # ------------------------------------------------------------------
    # TOD O: 6.  Follow the same instructions as in T ODO 3 above,
...
def test_move_by():
    ...
    """
    # ------------------------------------------------------------------
    # TO DO: 7.  Follow the same instructions as in TOD O 3 above,
...
def test_get_number_of_moves_made():
    ...
    """
    # ------------------------------------------------------------------
    # TO DO: 8.  Follow the same instructions as in TO DO 3 above,
...
def test_get_distance_from():
    ...
    """
    # ------------------------------------------------------------------
    # T ODO: 9.  Follow the same instructions as in T ODO 3 above,
...
def test_get_distance_from_start():
    ...
    """
    # ------------------------------------------------------------------
    # TOD O: 10.  Follow the same instructions as in TO DO 3 above,
...
def test_get_distance_traveled():
    ...
    """
    # ------------------------------------------------------------------
    # TOD O: 11.  Follow the same instructions as in TO DO 3 above,
...
def test_closer_to():
    ...
    """
    # ------------------------------------------------------------------
    # TO DO: 12.  Follow the same instructions as in TOD O 3 above,
